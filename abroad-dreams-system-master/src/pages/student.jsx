...
export default function student() {
  ...
  useEffect(() => {
    axios.get("http://localhost:3100/student_active/sushmita@gmail.com").then(doc => {
      const arr = [];
  ...
  return (
    <Container className='outer'>
      <h5>Welcome back <strong>Student</strong></h5>
      <br />
      <Tabs defaultActiveKey="institutions" className="mb-3">
        <Tab tabClassName="tab" eventKey="institutions" title="Your Institution">
            ...
            <div className="inner">
              ...
              <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                  <p className="p">Documents <h5>Submitted</h5></p>
                  <p className="p">Language Requirments <h5>iELTS 6.5+ </h5></p>
                </div>
                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                  <p className="p">Application Progress <br /><br /><ProgressBar variant='success' animated={true} now={80} label={`${80}%`} /></p>
                  {/*<p className="p">Potential Progress  <br /><ProgressBar variant='danger' animated={true} now={50} label={`${50}%`} /></p>*/}
                </div>
                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                  <p className="p">Min Required GPA <h5>3.0</h5></p>
        ...
        <Tab tabClassName="tab" eventKey="courses" title="Preferred Courses">
          <div className="wrapper">
            <button className="btn btn-dark" onClick={handleShow}>Add/Drop Preferred Courses</button>
            {courses.map(doc => {
              return (
                <div className='item'>
                  {doc.courseName}
        ...
        <Tab tabClassName="tab" eventKey="accessibility" title="Request Form">
          <div className="wrapper">
            <div>
              <h4 style={{marginTop: 20, fontWeight: "bold"}}>Request Form</h4>
